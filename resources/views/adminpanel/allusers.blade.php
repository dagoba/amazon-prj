...
@section('title')
  @lang('view_adminpanel.all_user_title')
@endsection
@section('content')
<div class="row">
    <div class="col-md-12">
        <div class="card bootstrap-table">
            <div class="card-header ">
                <h4 class="card-title">@lang('view_adminpanel.all_user_h4')</h4>
                <p class="card-category">@lang('view_adminpanel.all_user_description')</p>
            </div>
                            ...
                            <tbody>
                              ...
                              <tr data-index="0">                      
                                ...
                                <td class="td-actions text-right" style="">
                                  <a href="{{url('/admin/user/'.$user->id.'/balance')}}" rel="tooltip" title="@lang('view_adminpanel.all_user_manag_b')" class="btn btn-success btn-link btn-xs" data-original-title="@lang('view_adminpanel.all_user_manag_b')">
                                    <i class="fa fa-money"></i>
                                  </a>
                                  <a rel="tooltip" title="@lang('view_adminpanel.all_user_edit')" class="btn btn-info btn-link btn-xs" href="{{url('/admin/user/'.$user->id.'/edit')}}">
                                    <i class="fa fa-edit"></i>
                                  </a>
                                  @if($user->group_id != 1)
                                  <a rel="tooltip"title="@lang('view_adminpanel.all_user_closed')" class="btn btn-link btn-danger btn-xs manage_user" href="{{ route('closed-user')}}" data-user="{{$user->id}}">
