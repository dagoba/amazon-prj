...
@section('title')
 @lang('view_adminpanel.my_tickets_message_title')
@endsection
@section('content')
<div class="row">
    <div class="col-md-12">
        <div class="card ">
            <div class="card-header ">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form id="form-add-message" action="{{route('admin-add-message')}}" method="POST">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="message" name="message" placeholder="@lang('view_adminpanel.my_tickets_message_placeholder')">
                                    <div class="input-group-append">
                                        <button class="btn btn-info btn-outline-secondary">@lang('view_adminpanel.my_tickets_message_submit')</button>
                                    </div>
                                </div>                            
                                {{ csrf_field() }}
